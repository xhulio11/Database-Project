...
- Deliverable 1_corrected.pdf: corrected 1st deliverable of the assignment.
- student.mwb: database model in MySQL Workbench format.
- student.png: database model diagram as a png file extracted from MySQL Workbench.
